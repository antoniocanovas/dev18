...
This module allows users to choose the configuration mode
(Matrix Grid or Product Configurator)
before selecting products in sale order lines, providing
better control over the configuration workflow.
...
The configuration mode field appears before the product selection,
