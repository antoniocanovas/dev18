...
class AssortmentPair(models.Model):
    ...
    # Calcula la cantidad de pares en función de la cantidad de
    # la línea de movimiento de stock y la lista de materiales
    ...
    # CRON ACTION TO DELETE NULL ASSORTMENT PAIRS (revisar no es así porque los sm
    # y sml son fijos, se van adicionando):
