...
class ProductTemplate(models.Model):
    ...
    def _autosync_categ_id(self):
        for record in self:
            ...
            if record.is_assortment and shoes_categ_sync and categ != record.product_tmpl_single_id.categ_id.id:
                record.product_tmpl_single_id.categ_id = categ
            if record.is_pair and shoes_categ_sync and categ != record.product_tmpl_set_id.categ_id.id:
